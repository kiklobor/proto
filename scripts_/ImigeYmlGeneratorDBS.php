...
class ImigeYmlGeneratorDBS extends YmlGeneratorDBS {
    ...
    protected function offers() {
		global $go;
		$from='products p';
		$where='p.active=1 AND p.yml_active=1 AND p.availability="Товар в наличии"';
		$groupby='p.ID';
          ...
          $cellsPrepare['available'] = false;
				...
				$offers[] = array(
					...
					'data' => array(
						...
						'pickup' => true,
						'vendor' => 'ООО "Имидж"',
						'vendorCode' => $cellsPrepare['article'],
