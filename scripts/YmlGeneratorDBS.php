...
abstract class YmlGeneratorDBS  {
     ...
     * @var array
     */
    public $offerElements = array('name', 'url', 'price', 'currencyId', 'categoryId', 'picture', 'delivery', 'pickup',  'vendor',  'vendorCode',
            'description', 'param', 'delivery-options', 'pickup-options', 'cost', 'days', 'orderbefore', 'available' ,'sales_notes');
