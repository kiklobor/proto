...
class ImigeYmlGenerator extends YmlGenerator {
    ...
    protected function shopInfo() {
        return array(
            ...
            'delivery-options' => array('cost'=>300, 'days'=>'1-3', 'orderbefore'=>18),
            'pickup-options' => array('cost'=>0, 'days'=>1, 'orderbefore'=>18)
      );
    }
    ...
    protected function offers() {
        ...
        if (strtolower($row['availability']) == strtolower('Товар в наличии')) {
         ...
         /*   $cellsPrepare['delivery'] = array('cost'=>300, 'days'=>($dayss+1).'-'.($dayss+3));
            ...
            $cellsPrepare['delivery'] = array('cost'=>300, 'days'=>32, 'order-before'=>18);
            $cellsPrepare['pickupoptions'] = array('cost'=>0, 'days'=>32, 'order-before'=>18);
          } else
            $cellsPrepare['delivery'] = array('cost'=>300, 'days'=>'32'); //нечто а вдруг?
          $deliveryd = TRUE;
        } else {
