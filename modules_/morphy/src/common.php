...
class phpMorphy {
    ...
    function __construct($dir, $lang = null, $options = array()) {
        ...
        //echo "<pre>";var_dump($dir);echo "</pre>";echo "<pre>";var_dump($lang);echo "</pre>";echo "<pre>";var_dump($options);echo "</pre>";
        //echo "<pre>";var_dump(phpMorphy_FilesBundle);echo "</pre>";
        ...
        if($dir instanceof phpMorphy_FilesBundle && is_array($lang)) {
            ...
            //die("1111");
            //$t = $this->createFilesBundle($dir, $lang);
            //echo "<pre>";var_dump($t);echo "</pre>";
            //$this->initNewStyle($t, $options);
